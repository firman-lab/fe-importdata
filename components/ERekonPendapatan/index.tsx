...
import { activeStepRec, ereconPendapatanRec } from "../../store";
...
export default function ERekonPendapatan(prop : ActiveStepProps) {
  const { steplength } = prop;
  const [items, setItems] = useRecoilState(ereconPendapatanRec);
          ...
          <div className="col-12">
            <div className="card-body">
              <div className="text-center">
                <h2>Import Data E-Rekon Pendapatan</h2>
                    ...
                    <Table sx={{ minWidth: 650 }} aria-label="simple table">
                      <TableHead>
                        <TableRow>
                          ...
                          <TableCell align="center">PENDAPATAN NETTO</TableCell>
                          <TableCell align="center">
                        ...
                        {items.map((row: any, index: any) => (
                          ...
                          >
                            ...
                            <TableCell align="right">
                              {row["ESTIMASI PENDAPATAN"]}
                            </TableCell>
                            <TableCell align="right">
                              {row.PENDAPATAN}
                            </TableCell>
                            <TableCell align="right">
                              {row["PENGEMBALIAN PENDAPATAN"]}
                            </TableCell>
                            <TableCell align="right">
                              {row["PENDAPATAN NETTO"]}
                            </TableCell>
                            <TableCell align="center">
                              {row["% REALISASI PENDAPATAN"]}
                            </TableCell>
                          </TableRow>
                        ))}
                      </TableBody>
