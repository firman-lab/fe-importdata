                    ...
                    <Table sx={{ minWidth: 650 }} aria-label="simple table">
                      <TableHead>
                        <TableRow>
                          ...
                          <TableCell align="center">KDBEAS1</TableCell>
                          <TableCell align="center">KDSATKER</TableCell>
                          <TableCell align="center">KDDEKON</TableCell>
                          <TableCell align="center">JNSDOK1</TableCell>
                          <TableCell align="center">TGLDOK1</TableCell>
                          <TableCell align="center">NODOK1</TableCell>
                          <TableCell align="center">JRN_BMN</TableCell>
                          <TableCell align="center">URAIAN</TableCell>
                          <TableCell align="center">PERKKOR</TableCell>
                          <TableCell align="center">PERKKOR1</TableCell>
                          <TableCell align="center">RHPREAL</TableCell>
                        </TableRow>
                      </TableHead>
                      <TableBody>
                        {items.map((row: any, index: any) => (
                          ...
                          >
                            ...
                            <TableCell align="center">{row.NODOK1}</TableCell>
                            <TableCell align="center">{row.JRN_BMN}</TableCell>
